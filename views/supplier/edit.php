  ...
  <div style="padding:24px;">
    <form method="POST" action="" novalidate>
      ...
      <div style="display:flex;gap:12px;justify-content:flex-end;padding-top:20px;margin-top:10px;border-top:1px solid #e2e8f0;">
        ...
        <button type="submit" style="padding:10px 28px;border-radius:9px;border:none;background:linear-gradient(135deg,#1e40af,#2563eb);color:#fff;font-size:13px;font-weight:700;cursor:pointer;box-shadow:0 4px 12px rgba(30,64,175,.25);"><i class="fas fa-save" style="margin-right:5px;"></i> Cập nhật</button>
      </div>
    </form>
  </div>
</div>
