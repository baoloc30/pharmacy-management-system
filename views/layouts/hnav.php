...
elseif (strpos($cur, 'warehouse') !== false || strpos($cur, 'forecast') !== false) $activeGroup = 'warehouse';
    ...
    <div class="subnav-inner">
        ...
        <?php if ($isAdmin): ?>
            ...
            <div class="subnav-panel <?php echo $activeGroup === 'warehouse' ? 'active' : ''; ?>" id="snp-warehouse">
                ...
                <a href="<?php echo BASE_URL; ?>warehouse/pending"
                    class="sn-tab <?php echo strpos($cur, 'warehouse/pending') !== false ? 'active' : ''; ?>"
                    style="background:<?php echo $colors[2]['bg']; ?>;">
                    <i class="fas fa-clipboard-list"></i> Phiếu chờ duyệt
                </a>
                ...
                <a href="<?php echo BASE_URL; ?>forecast/index"
                    class="sn-tab <?php echo strpos($cur, 'forecast') !== false ? 'active' : ''; ?>"
                    style="background:<?php echo $colors[4]['bg']; ?>;">
                    <i class="fas fa-magic"></i> D&#7921; b&#225;o nh&#7853;p kho (AI)
                </a>
            </div>
...
<script>
    function switchSubnav(group) {
        document.querySelectorAll('.subnav-panel').forEach(function(p) {
            p.classList.remove('active');
        });
        var panel = document.getElementById('snp-' + group);
        if (panel) panel.classList.add('active');
        document.querySelectorAll('.sb-menu li a').forEach(function(a) {
